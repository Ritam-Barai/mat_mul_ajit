...
#system.shared_ranges = AddrRange(0x04000000,size='8B')
...
#system.simulate_shared_mem = True
# Example shared memory setup
shared_virt_base = 0x04000000
shared_mem_size = 128 * 1024 * 1024
...
process1.pid = 100
#process1.map = [(shared_virt_base,shared_virt_base, shared_mem_size)]
...
process2.pid = 101
#process1.memmap = [(shared_virt_base, shared_mem_size)]
